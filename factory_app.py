...
<style>
    ...
    /* 微调拦截区 text_area 放大 */
    .stTextArea textarea { font-size: 0.95rem; line-height: 1.6; min-height: 260px; }
    /* 按钮 */
    .stButton button {
        border-radius: 8px;
        font-weight: 500;
    ...
    .sidebar-history { font-size: 0.85rem; color: #6b7280; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0; }
</style>
""",
